...
// Note: An Armstrong number of a three-digit number is a number in which the sum of the cube of the digits
// is equal to the number itself. Hence 153 is an Armstrong number.
